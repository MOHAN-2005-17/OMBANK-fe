...
export const ClientMenu = (props) => {
    ...
    return (
        <ul>
            ...
            <SideLink onClickHandler={changePage} active={page} page="transfer" icon="bx bx-transfer" text="Transfer Funds" />
...
export const SideMenu = (props) => {
    ...
    return (
        <ul>
            ...
            <SideLink onClickHandler={changePage} active={page} page="transfer" icon="bx bx-transfer" text="ransfer Funds" />
